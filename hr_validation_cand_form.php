...
$query =" SELECT * FROM hr_cand_form_validation ";
...
<td><a href="<?php  echo 'insert_hr_validation_cand_form.php?select=true&c_id='.$row['c_id'] ; ?>"><button   class="btn btn-primary btn-sm" >Choose</button></a></td>
           ...
           <div class="col-lg-12">
                                ...
                                <div class="card " id="Candidate-info"  >
                                    <div class="card-header">
                                       <h3>
                           Documnets uploaded by candidate</h3>
                        <span class="red fullWidth" style="color: green; font-size: 12px;">Please give the review  before rejecting/accepting.</span> 
                                    </div>
                                    <div class="card-body card-block">
                                        <form action="insert_hr_validation_cand_form.php" method="post" enctype="multipart/form-data" class="form-horizontal">
