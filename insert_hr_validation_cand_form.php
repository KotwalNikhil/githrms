...
if(isset($_GET['select']))
		{
			...
			header("Location: hr_validation_cand_form.php?msg=" .$msg. "&type=".$type);
			exit();
		}
...
if (isset($_POST['confirmed_hr']))
 {
 	$review =$_POST['hr_review'];
						...
						$mail->Subject = 'HR Reviews for'.$result1['full_name'].'  documents and employment form ';
						$mail->Body    = 'The documnents have been approved from HR, Kindly go through the reviews in portal.';
...
/////////////////////////////
							...
							$command = "DELETE from hr_cand_form_validation  WHERE c_id = '$c_id'  ";
      						$ssql = mysqli_query($db,$command) ;

      						$command = "UPDATE review_cand_docs SET hr_confirmed=1,hr_review='$review' WHERE c_id = '$c_id'  ";
      						$ssql = mysqli_query($db,$command) ;
 ...
 if (isset($_POST['rejected_hr']))
 {
 	$review =$_POST['hr_review'];
			...
			/////////////// email from hr to recuriter ////////////////
						...
						$mail->Subject = 'HR Reviews for'.$result1['full_name'].'  documents and employment form ';
						$mail->Body    = 'The documnents have been Rejected from HR, Kindly go through the reviews in portal.';
						$mail->AltBody = 'This is the body in plain text for non-HTML mail clients';
...
/////////////////////////////
							...
							$command = "DELETE from hr_cand_form_validation  WHERE c_id = '$c_id'  ";
      						...
      						$command = "UPDATE review_cand_docs SET hr_confirmed=0 ,hr_review='$review' WHERE c_id = '$c_id'  ";
      						$ssql = mysqli_query($db,$command) ;
